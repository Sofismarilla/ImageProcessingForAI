...
ap.add_argument("-w", "--watermark pyimagesearch_watermark.png", required=True, default="D:\MASTER\SEM2\Image Processing\FINAL EXAM\watermark\pyimagesearch_watermark.png",
	help="path to watermark image (assumed to be transparent PNG)")
ap.add_argument("-i", "--input input", required=True,
	help="path to the input directory of images")
ap.add_argument("-o", "--output output", required=True,
